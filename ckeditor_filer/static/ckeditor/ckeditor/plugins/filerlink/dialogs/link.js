                ...
                },
                {
                    ...
                    },
                    {
                        ...
                        filebrowser: {
                            action: 'Browse',
                            target: 'info:url',
                            url: '/richtext-link-page-select/?_popup=1'
                        },
                        label: 'Seiten'
                    },
                    {
                        type: 'html',
                        id: 'browseNews',
                        html: '<a style="user-select: none;"' +
                            ' title="News suchen und verlinken" hidefocus="true"' +
                            ' class="cke_dialog_ui_button" aria-labelledby="cke_92_label"' +
                            ' id="lookup_cknews"' +
                            ' onclick="return showRelatedObjectLookupPopup(this);"' +
                            ' href="/admin/news/newspost/?_to_field=id"><span class="cke_dialog_ui_button">News</span></a>',
                    },
                    {
                        type: 'html',
                        id: 'browseOffers',
                        html: '<a style="user-select: none;"' +
                            ' title="Angebot suchen und verlinken" hidefocus="true"' +
                            ' class="cke_dialog_ui_button" aria-labelledby="cke_92_label"' +
                            ' id="lookup_ckoffers"' +
                            ' onclick="return showRelatedObjectLookupPopup(this);"' +
                            ' href="/admin/offer/offer/?_to_field=id"><span class="cke_dialog_ui_button">Angebote<span></a>',
                    } ]
                },
                {
                    type: 'vbox',
